...
app.locals.agent_layout_directory = '../../../../views/agent/layouts';
app.locals.agent_partial_directory = '../../../../views/agent/partials';
...
const getAgentFolderName = config.getAgentFolderName;
