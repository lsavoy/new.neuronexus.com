...
var KTDatatablecategory = function () {
    ...
    var options = {
        ...
        }, 
        {
            ...
            template: function (row) {
                return '\
                    \<a href="'+window.location.protocol+'//'+ window.location.host + '/category/edit/' + row._id + '" class="btn btn-sm btn-clean btn-icon btn-icon-sm" title="Edit">\
    ...
    var categorySelector = function () {
        ...
        $(document).on('click', '.ktDelete', function () {
            ...
            swal.fire({
                ...
                if (result.value) {
                    window.location.href = `${window.location.protocol}//${window.location.host}/category/delete/${elemID}`;
                }
            });
        });
    };
