...
var KTDatatableproduct = function () {
    ...
    var options = {
        ...
        data: {
            ...
            source: {
                read: {
                    url: `${window.location.protocol}//${window.location.host}/product/getall`,
                },
            },
            pageSize: 10,
            serverPaging: true,
        ...
        columns: [
            ...
            },
            {
                ...
                template: function (row) {
                    return '\
                    \<a href="' + window.location.protocol + '//' + window.location.host + '/product/edit/' + row._id + '" class="btn btn-sm btn-clean btn-icon btn-icon-sm" title="Edit">\
    ...
    var productSelector = function () {
        ...
        var datatable = $('#productSelection').KTDatatable(options);
        ...
        $(document).on('click', '.ktDelete', function () {
            ...
            swal.fire({
                ...
                if (result.value) {
                    window.location.href = `${window.location.protocol}//${window.location.host}/product/delete/${elemID}`;
                }
            });
        });
    };
