...
var KTDatatablecategory = function () {
    ...
    var options = {
        ...
        data: {
            ...
            source: {
                read: {
                    url: `${window.location.protocol}//${window.location.host}/about/leadership/getall`,
                },
            },
            pageSize: 10,
            serverPaging: true,
        ...
        columns: [
            ...
            },
            {
                ...
                template: function (row) {
                    return '\
                    \<a href="' + window.location.protocol + '//' + window.location.host + '/about/leadership/edit/' + row._id + '" class="btn btn-sm btn-clean btn-icon btn-icon-sm" title="Edit">\
    ...
    var categorySelector = function () {
        ...
        var datatable = $('#leadershipSelection').KTDatatable(options);
        ...
        $(document).on('click', '.KTStatusUpdate', function () {
            ...
            swal.fire({
                ...
                if (result.value) {
                    window.location.href = `${window.location.protocol}//${window.location.host}/about/leadership/status-change/${elemID}`;
                }
            });
        })
        ...
        $(document).on('click', '.ktDelete', function () {
            ...
            swal.fire({
                ...
                if (result.value) {
                    window.location.href = `${window.location.protocol}//${window.location.host}/about/leadership/delete/${elemID}`;
                }
            });
        });
    };
