    ...
    var options = {
        ...
        },
        {
            ...
            template: function(row) {
                return `${row.content.substring(0, 250)}...`;
            }
            // template: '{{content}}',
        },

        {
            ...
            template: function(row) {
	            return '\
                    \<a href="'+window.location.protocol+'//'+window.location.host+'/cms/edit/'+row._id+'" class="btn btn-sm btn-clean btn-icon btn-icon-sm" title="Edit">\
    ...
    var cmsSelector = function() {
        ...
        $(document).on('click', '.KTStatusUpdate', function(){
            ...
            swal.fire({
                ...
                if (result.value) {
                    window.location.href = `${window.location.protocol}//${window.location.host}/cms/status-change/${elemID}`;
                }
            });
        })
        ...
        $(document).on('click', '.ktDelete', function(){
            ...
            swal.fire({
                ...
                if (result.value) {
                    window.location.href = `${window.location.protocol}//${window.location.host}/cms/delete/${elemID}`;
                }
            });
        });        
    };
