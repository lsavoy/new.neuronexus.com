...
namedRouter.get("dashboard.getallAuthorCount", '/dashboard/getallAuthorCount', async (req, res) => {
    try {
...
namedRouter.get("dashboard.getallMealCount", '/dashboard/getallMealCount', async (req, res) => {
    try {
