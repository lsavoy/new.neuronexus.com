...
const Permission = require('user/models/permissions.model');
...
const userRepository = {
    ...
    getPermissionByField: async (params) => {

        try {
            let user = await Permission.findOne(params).exec();
            if (!user) {
                return null;
            }
            return user;
    ...
    savePermission: async (data) => {
        try {
            let user = await Permission.create(data);
    ...
    updatePermissionById: async (data, id) => {
        try {
            let user = await Permission.findByIdAndUpdate(id, data, {
                new: true
            });
